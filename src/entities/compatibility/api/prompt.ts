...
- 추상적으로 설명하지 말고 연애에서 실제로 겪을 구체적인 행동이나 상황으로 보여준다.
  - ❌ "소통을 잘해" → ✅ "카톡 읽고 바로 답장 안 해도 '읽씹 아니야, 생각 중이야' 하고 먼저 말해주는 타입이야"
  - ❌ "서로를 이해해" → ✅ "기념일 깜빡해도 다음 날 더 크게 챙겨주면 '이게 더 좋은데?' 하고 넘어가줘"
...
- 친구가 "야 너네 둘 이런 느낌이야" 하고 알려주는 톤이다.
...
- summary: "처음엔 서로 템포가 안 맞는 것 같아도 한 번 빠지면 헤어 나오기 힘든 조합이야."
- advice: "싸우고 나서 바로 해결하려 하지 말고 '나 좀 정리하고 얘기할게' 한마디면 훨씬 부드러워져."`;
